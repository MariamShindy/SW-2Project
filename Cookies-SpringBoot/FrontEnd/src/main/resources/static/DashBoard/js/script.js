    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        userDdBtn.addEventListener('click', function (e) {
          ...
          if (e.currentTarget.classList.contains('danger')) {
            // Handle logout logic here (redirect to the logout page, etc.)
            // For now, let's assume you want to navigate to the logout page
            window.location.href = e.currentTarget.getAttribute('href');
          } else {
            // Handle other dropdown logic here
