package com.feedbackService.Aop;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.feedbackService.service.FeedbackService.*(..))")
    public void logBefore(JoinPoint joinPoint) {
        logger.info("Method invoked====>: {}", joinPoint.getSignature().getName());
    }

    @AfterReturning(pointcut = "execution(* com.feedbackService.service.FeedbackService.*(..))", returning = "result")
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        logger.info("Method returned====>: {}", result);
    }

    @Around(value = "execution(* com.feedbackService.service.FeedbackService.*(..))")
