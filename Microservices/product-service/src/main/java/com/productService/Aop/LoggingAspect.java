...
public class LoggingAspect {
    ...
    @Before("execution(* com.productService.services.ProductService.*(..))")
    public void logBefore(JoinPoint joinPoint) {
        logger.info("Method invoked====>: {}", joinPoint.getSignature().getName());
    }

    @AfterReturning(pointcut = "execution(* com.productService.services.ProductService.*(..))", returning = "result")
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        logger.info("Method returned====>: {}", result);
    }

    @Around(value = "execution(* com.productService.services.ProductService.*(..))")
