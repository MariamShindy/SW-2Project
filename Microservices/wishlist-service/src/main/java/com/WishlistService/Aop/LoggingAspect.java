package com.WishlistService.Aop;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.WishlistService.service.WishlistService.*(..))")
    public void logBefore(JoinPoint joinPoint) {
        logger.info("Method invoked====>: {}", joinPoint.getSignature().getName());
    }

    @AfterReturning(pointcut = "execution(* com.WishlistService.service.WishlistService.*(..))", returning = "result")
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        logger.info("Method returned====>: {}", result);
    }

    @Around(value = "execution(* com.WishlistService.service.WishlistService.*(..))")
