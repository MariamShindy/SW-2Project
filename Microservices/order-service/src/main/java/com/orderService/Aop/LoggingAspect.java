...
public class LoggingAspect {
    ...
    @Before("execution(* com.orderService.service.OrderService.*(..))")
    public void logBefore(JoinPoint joinPoint) {
        logger.info("Method invoked====>: {}", joinPoint.getSignature().getName());
    }

    @AfterReturning(pointcut = "execution(* com.orderService.service.OrderService.*(..))", returning = "result")
    public void logAfterReturning(JoinPoint joinPoint, Object result) {
        logger.info("Method returned====>: {}", result);
    }

    @Around(value = "execution(* com.orderService.service.OrderService.*(..))")
